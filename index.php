            ...
            <section class="large-8 columns main-column">
                ...
                <div class="category-row">
                    ...
                    <p class="call-to-action clearfix">
                        <a href="<?php the_permalink(bastille_get_programmes_page());?>" class="small button post-item-buttom radius"><?php _e('All programmes','bastille')?></a>
                    </p>
            ...
            <aside id="sidebar" class="large-4 columns">
                <div class="columns large-12 category-header no-padding-left no-padding-right">
                    <div class="small-5 large-5 columns no-padding-left">
                        <h3 class="category-title"><?php echo bastille_get_events_label();?></h3>
                    </div>
                ...
                <div class="event-widget">
                    ...
                    <p class="call-to-action">
                        ...
                        <a href="<?php the_permalink(bastille_get_events_page());?>" class="small button radius"><?php _e('All events','bastille')?></a>
                    </p>
                </div>
            </aside>
        </section>
