...
/*
================================================================================================
Bastille functions and definitions
================================================================================================
@package        Bastille
...
if ( ! function_exists( 'bastille_setup' ) ) :
/**
 ...
 */
function bastille_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Bastille, use a find and replace
	 * to change 'bastille' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'bastille', get_template_directory() . '/languages' );
